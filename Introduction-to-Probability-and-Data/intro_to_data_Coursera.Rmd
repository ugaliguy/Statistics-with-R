...
**Answer**: The narrowest bandwidth gives the best idea of the shape of the data.
The widest bandwidth gives a better idea of the height (i.e. count) of the data.
</div>
...
sfo_feb_flights %>%
  group_by(carrier) %>%
  summarise(med_ad = median(arr_delay), iqr_ad = IQR(arr_delay), n = n())
```
